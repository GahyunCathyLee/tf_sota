...
# -*- coding: utf-8 -*-
"""
split.py — Train / Val / Test split generator for exiD preprocessed data.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  # Custom paths
  python split.py \\
      --label_file data/exiD/mmap/scenario_labels.csv \\
...
# ──────────────────────────────────────────────────────────────────────────────
DEFAULT_LABEL_FILE = "data/exiD/mmap/scenario_labels.csv"
DEFAULT_OUTPUT_DIR = "data/exiD/splits"
...
def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        description="Generate train/val/test index splits for exiD mmap dataset.",
